...
from odoo.addons.egd_sale_blanket_order_revision.models.sale_blanket_order import (
    SaleBlanketOrder,
)
from odoo.addons.egd_sale_blanket_order_revision.wizard import (
...
class TestSaleBlanketOrderRevision(TransactionCase):
    ...
    def test_update_blanket_order_lines_with_adjustment(self):
        ...
        old_order = FakeWritable(
            ...
            egd_use_sale_order_plan=True,
            egd_order_product_ids=[1],
            egd_order_service_ids=[2],
            egd_sale_order_plan_ids=[3],
            line_ids=[old_line],
        )
        new_order = FakeWritable(
            analytic_account_id=False,
            egd_use_sale_order_plan=False,
            egd_order_product_ids=[],
            egd_order_service_ids=[],
            egd_sale_order_plan_ids=[],
            line_ids=[new_line],
        )
